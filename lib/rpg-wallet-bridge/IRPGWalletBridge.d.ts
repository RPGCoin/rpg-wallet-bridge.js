...
export default interface IRPGWalletBridge {
    /**
     ...
     * @example
     * const address = await rpgWalletBridge.getAddress(
     *   "receive",
     *   3,
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     * console.log(address)
     * > "rpgcoin:qrsy0xwugcajsqa99c9nf05pz7ndckj55ctlsztu2p"
     ...
     * @example
     * const addrIdx = await rpgWalletBridge.getAddressIndex(
     *   "change",
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     * console.log(addrIdx)
     ...
     * @example
     * const addresses = await rpgWalletBridge.getAddresses(
     *   "receive",
     *   3,
     *   2,
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     ...
     * @example
     * const redeemScript = await rpgWalletBridge.getRedeemScript(
     *   "rpgcoin:prr7qqutastjmc9dn7nwkv2vcc58nn82uqwzq563hg",
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     ...
     * @example
     * const redeemScripts = await rpgWalletBridge.getRedeemScript(
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     * console.log(redeemScript)
     ...
     * @example
     * await rpgWalletBridge.addRedeemScript(
     *   "03424f587e064249..."
     * )
     ...
     * @example
     * const utxos = await rpgWalletBridge.getUtxos(
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     * console.log(utxos)
     * > [
     ...
     * @example
     * const balance = await rpgWalletBridge.getBalance(
     *   "53212266f7994100e442f6dff10fbdb50a93121d25c196ce0597517d35d42e68"
     * )
     * console.log(balance)
     * > 500000
     ...
     * @example
     * const result = await rpgWalletBridge.sign(
     ...
     * @returns The signed data. Rpgcoin signatures are serialised in the DER format over the wire.
     */
     ...
     * @example
     * const rawTx = await rpgWalletBridge.buildTransaction([
     *   {
     ...
     * @example
     * const version = await rpgWalletBridge.getProtocolVersion()
     * console.log(version)
     * > 70015
     ...
     * @example
     * const fee = await rpgWalletBridge.getFeePerByte()
     * console.log(fee)
     * > 1
